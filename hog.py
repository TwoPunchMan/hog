...
def hefty_hogs(player_score, opponent_score):
	...
	while opponent_score > 0:
		...
		apply_func = digit_fn(last_digit)
		player_score = apply_func(player_score)
		opponent_score //= 10
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
	...
	while max(score0, score1) < goal:
		if who == 0:
			score0 += take_turn(num_rolls=strategy0(score0, score1), player_score=score0, opponent_score=score1, dice=dice, goal=GOAL_SCORE)
			score0 += hog_pile(score0, score1)
		else:
			score1 += take_turn(num_rolls=strategy1(score1, score0), player_score=score1, opponent_score=score0, dice=dice, goal=GOAL_SCORE)
